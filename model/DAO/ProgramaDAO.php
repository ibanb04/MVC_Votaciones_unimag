...
class ProgramaDAO {
    ...
    public function buscarPrograma($table, $nameRow, $value){
        ...
        public function insertPrograma_ProgramaDAO(Programa $programa, $table){
        $data_source= new DataSource();
        $sql = "INSERT INTO $table ( nombre, facultad_id) VALUES (:nombre, :facultad_id)";
        
        $resultado = $data_source->ejecutarActualizacion($sql, array(
                ':nombre'=>$programa->getnombre(),
                ':facultad_id'=>$programa->getfacultad_id()
            )
        );
    ...
    public function updatePrograma_ProgramaDAO(Programa $programa, $table){
        $data_source= new DataSource();
